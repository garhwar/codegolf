...
echo '<br><br><form method="POST" action="problems.php">
<p>Username: <input type=text name="uname"></p>
<p>Password: <input type=password name="pwd"></p>
<input class="button" style="font-family:Courier New;background-color:green;color:white;margin-left:11cm;" type=submit name="loginbutton" value="Login"><br>
</form>';
?>
</html>
